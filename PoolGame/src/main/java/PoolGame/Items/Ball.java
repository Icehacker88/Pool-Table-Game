...
import PoolGame.Observer.concreteSubject;
...
public class Ball implements Drawable, Movable {
    ...
    public Ball(String colour, double xPos, double yPos, double xVel, double yVel, double mass, BallType type, BallPocketStrategy pocketAction) throws IllegalArgumentException {
        ...
        mouseDragLine.setStroke(Color.BROWN);
        mouseDragLine.setStrokeWidth(5);
    ...
    /**
     * Get color of the ball as String
     * @return The string of ball's color
     */
    ...
    /**
     * Load the state and make the ball to the setting state
     * @param disable Set if the ball on the table
     * @param x The x-axis of the ball
     * @param y The y-axis of the ball
     * @param fall The counts of fallCounter
     */
    public void setSave(Boolean disable, Double x, Double y, int fall) {
        this.disabled = disable;
        this.shape.setVisible(!disable);
        this.shape.setCenterX(x);
        this.shape.setCenterY(y);
        this.vel[0] = 0.0;
        this.vel[1] = 0.0;
        this.fallCounter = fall;
    }
    ...
    */
    ...
    public void fallIntoPocket(Game game) {
        ...
        concreteSubject s = new concreteSubject(game);
//        s.attach(new concreteObserver(s));
        s.setScore(String.valueOf(this.colour));
        score = s.getScore();
